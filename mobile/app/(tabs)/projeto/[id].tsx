...
const s = StyleSheet.create({
  ...
  actionCard: { flex: 1, minWidth: 140, maxWidth: '48%', borderWidth: 1, borderRadius: 14, padding: 14, gap: 8 },
  ...
  infoMiniCard: { flex: 1, minWidth: 85, borderWidth: 1, borderRadius: 12, padding: 12, gap: 6 },
