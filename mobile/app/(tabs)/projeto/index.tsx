...
const s = StyleSheet.create({
  ...
  metaCard: { minWidth: 135, borderWidth: 1, borderRadius: 14, padding: 12, gap: 8 },
  ...
  painelCardMetade: { flex: 1, minWidth: 140, borderWidth: 1, borderRadius: 16, padding: 14, gap: 10 },
