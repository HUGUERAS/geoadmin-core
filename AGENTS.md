...
- `GET /projetos/{id}/documentos` — painel documental com checklist dinâmico (derivado das tabelas reais)
- `POST /projetos/{id}/pacote-final` — ZIP com todos os documentos gerados do projeto (rate 3/min, requer token)
